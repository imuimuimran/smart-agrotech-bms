...
// Purchase Invoice Main Tracking States
...
// Internal Three-Way Matching Engine Matrix Pointers
...
// Granular Result Variance Classifications
...
// Operational Invoice Lifecycle States (Page 1)
...
export const PURCHASE_INVOICE_STATUS_LIST = Object.values(PURCHASE_INVOICE_STATUS);

// Three-Way Matching Process Workflows (Page 2)
export const PURCHASE_INVOICE_MATCH_STATUS = {
  NOT_STARTED: 'NOT_STARTED',
  IN_PROGRESS: 'IN_PROGRESS',
  MATCHED: 'MATCHED',
  PARTIAL_MATCH: 'PARTIAL_MATCH',
...
export const PURCHASE_INVOICE_MATCH_STATUS_LIST = Object.values(PURCHASE_INVOICE_MATCH_STATUS);

// Three-Way Matching Analytical Result Engine Flags (Page 2)
export const PURCHASE_INVOICE_MATCH_RESULT = {
  FULL_MATCH: 'FULL_MATCH',
  PARTIAL_MATCH: 'PARTIAL_MATCH',
  PRICE_VARIANCE: 'PRICE_VARIANCE',
  QUANTITY_VARIANCE: 'QUANTITY_VARIANCE',
...
export const PURCHASE_INVOICE_MATCH_RESULT_LIST = Object.values(PURCHASE_INVOICE_MATCH_RESULT);

// Invoice Approval Pipeline States (Page 3)
export const PURCHASE_INVOICE_APPROVAL_STATUS = {
  PENDING: 'PENDING',
  APPROVED: 'APPROVED',
  REJECTED: 'REJECTED'
};
export const PURCHASE_INVOICE_APPROVAL_STATUS_LIST = Object.values(PURCHASE_INVOICE_APPROVAL_STATUS);

// Granular Audit Exception Variance Classifications (Page 4)
export const PURCHASE_INVOICE_VARIANCE_TYPE = {
  QUANTITY: 'QUANTITY',
  PRICE: 'PRICE',
  TAX: 'TAX',
  DISCOUNT: 'DISCOUNT',
...
export const PURCHASE_INVOICE_VARIANCE_TYPE_LIST = Object.values(PURCHASE_INVOICE_VARIANCE_TYPE);

// Auditable History Logging Actions (Page 5)
export const PURCHASE_INVOICE_APPROVAL_ACTION = {
  SUBMITTED: 'SUBMITTED',
  APPROVED: 'APPROVED',
  REJECTED: 'REJECTED',
  SENT_FOR_REVIEW: 'SENT_FOR_REVIEW'
};
export const PURCHASE_INVOICE_APPROVAL_ACTION_LIST = Object.values(PURCHASE_INVOICE_APPROVAL_ACTION);

// Three-Way Cross Examination Evaluation Dimensions (Page 5)
export const PURCHASE_INVOICE_MATCH_DIMENSION = {
  QUANTITY: 'QUANTITY',
  PRICE: 'PRICE',
  TAX: 'TAX',
  TOTAL: 'TOTAL',
