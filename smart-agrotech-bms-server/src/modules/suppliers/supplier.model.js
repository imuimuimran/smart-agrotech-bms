...
const contactPersonSchema = new Schema({
  name: { type: String, required: [true, "Contact person name is required"], trim: true },
...
const supplierSchema = new Schema({
  ...
  supplierCode: { type: String, trim: true, unique: true, sparse: true },
  ...
  currentPayable: { type: Number, default: 0, min: 0 },
  currency: {
    type: String,
